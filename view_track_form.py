...
async def main():
    ...
    # Click the FIRST track in the list to open its details if not already open
    # SoundOn track list usually expands the first one, or we can just scroll down
    await page._page.screenshot(path="track_form_view.png", full_page=True)
    print("Saved track_form_view.png")
