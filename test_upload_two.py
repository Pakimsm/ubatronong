...
async def main():
    ...
    # Save final page state screenshot
    await page.screenshot(path="frozen_pitchers_2_final.png", full_page=True)
    print("Saved frozen_pitchers_2_final.png")
    ...
    await page.screenshot(path="drafts_after_frozen_2.png", full_page=True)
    print("Saved drafts_after_frozen_2.png")
